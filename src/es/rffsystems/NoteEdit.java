...
public class NoteEdit extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*
         * Al fer un edit de la nota, tornem a a crear una indtancia per a poder 
         * accedir a la bd
         */
        ...
        confirmButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                finish(); // sortim de l'activitat
            }

        });

        /*
         * Si al comenar una activitat el focus el te un edittext, 
         * s'obre automaticament el teclat, per evitar-ho per ara
         * fem focus al bot— confirmar. 
         * 
    ...
    /*
     * Obtenim el valor dels elements de la nota.
     */
